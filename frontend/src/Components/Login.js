...
const Login = () => {
  ...
  const googleLogin = useGoogleLogin({
    onSuccess: async (response) => {
      try {
        ...
        showToast(err.response?.data?.message || 'An error occurred during Google login', 'error');
  ...
  const handleSubmit = async (e) => {
    ...
    try {
      ...
      showToast(err.response?.data?.message || 'An error occurred during login', 'error');
